...
<style type="text/css">
    ...
    <link rel="stylesheet" href="{{ URL('/public') }}/public_site_assets/css/style.default.css" id="theme-stylesheet">
      ...
      <nav class="side-navbar">
          <div class="side-navbar-wrapper">
            ...
            <div class="sidenav-header d-flex align-items-center justify-content-center">
              <!-- User Info-->
              <div class="sidenav-header-inner text-center"><a href="{{url('welcome')}}"><img src="{{ URL('/public') }}/public_site_assets/img/Group 2.png" class=""></a>

              </div>
              <!-- Small Brand information, appears on minimized sidebar-->
              <div class="sidenav-header-logo"><a href="index.html" class="brand-small text-center"><img src="{{ URL('/public') }}/public_site_assets/img/App Icon.png" class="w-100" alt=""></a></div>
            </div>
        ...
        <div class="page">
         ...
         <header class="header">
                    ...
                    <li class="nav-item">
                      <a href="" class="nav-link p-1">
                       <span class="d-none d-sm-inline-block">
                        <img src="{{ URL('/public') }}/public_site_assets/img/User.png" class="border p-1 rounded-circle">
                      </a>
                    </li>
                    <li class="nav-item">
          ...
          <script src="{{ URL('/public') }}/public_site_assets/vendor/jquery/jquery.min.js"></script>

          <script type="text/javascript">

            (function worker() {
              $.ajax({
                url: '{{ url("/") }}/notifications_ajax_load/{{ $user_info->id }}',
                dataType: 'json',
                success: function(data) {
                    ...
                    $.each(data, function(index, val) {
                        row += "<li>";
                        row += "<a rel='nofollow' href='#' class='dropdown-item' data-user-id='"+ val.id +"'>";
                        row += "<div class='notification d-flex justify-content-between'>";
                        row += "<div class='notification-content'><i class='fa fa-envelope'></i> A new message from "+ val.name +"</div>";
                        row += "<div class='notification-time'><small>"+ val.created_at +"</small></div>";
                        row += "</div>";
                        row += "</a>";
                        row += "</li>";
                    });

                    $('#notifications_ajax_load').html(row);
                    // $('#noft-noti-count').html(data[1].notification_count);

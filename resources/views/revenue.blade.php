        ...
        <div class="col-md-9 p-4 rounded m-auto"style="background:white;">
            <form action="">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control bg-primary" name="" placeholder="2019" id="date_1">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-4 mt-2">
                ...
                <div class="row mt-3">
                    <div class="col-md-4 mt-2">
                        <label for="" class="time_period text-left">Volume Growth Rate:</label>
                    </div>
                    <div class="col-md-4">
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row mt-3">
                    <div class="col-md-4 mt-2">
                        <label for="" class="time_period text-left">Price Per Unit:</label>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="" placeholder="$2,000" id="" style="background-color:goldenrod;color:white;">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-4">
                ...
                <div class="text-right mt-4">
                    <a href="{{ URL('/taxes') }}" class="bnt-33" style="text-decoration: none;color: white;">Submit</a>
                </div>
            </form> 
        </div>
    </div>

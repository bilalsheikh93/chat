...
<!--model input-actual-value form-->

  <div id="form-step-6">
    
    <form action="{{ url('/add_step_5') }}" method="POST">
        ...
        <div class="row m-3 pl-0 pr-0">
          ...
          <div class="col-md-9 pl-0 pr-0 pb-5" style="background:white; overflow:hidden;">
            <div class="row">
              <div class="col-md-12 pl-0 pr-0">
                <div class="border-bottom ml-3 mr-3">
                  <h5 class="p-2 ml-3 mt-3 font-weight-bold" style="font-size: inherit;">Actual Values</h5>
                </div>
                ...
                <div class="mt-5 pt-5 fmrs">
                  <div class="form-row ml-3 mr-3 border-top">
                    ...
                    <div class="col-md-6 mt-4 pr-3 text-right">
                        <button type="submit" class="bnt-21 w-25" id="btn-1-5">Next</button>
                    </div>
                  </div>
                </div>
              </div>
...
<script>
    $(function(){
        $("#btn-1-5").click(function(){
            ...
            {
                alert("Sorry! Please Select one Actual Value");
                return false;
            }
        });
    });

                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content border-0 modl">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="form-signin needs-validation" novalidate role="form" method="POST" action="{{ url('save_forgotpassword') }}">
                            ...
                            @endif
                                ...
                                <div class="form-group col-md-9 m-auto pt-4">
                                    <label for="validationCustom01" style="font-weight: 600;">New Password</label>
                                    <input type="password" id="validationCustom01" class="form-control" required aria-describedby="emailHelp" placeholder="Enter your New Password" name="new_password">
                                ...
                                <div class="form-group col-md-9 m-auto pt-4">
                                    <label for="validationCustom02" style="font-weight: 600;">Confirm Password</label>
                                    <input type="password" id="validationCustom01" class="form-control" required placeholder="Enter your Confirm Password" name="confirm_password">
                                    <div class="invalid-feedback text-left">

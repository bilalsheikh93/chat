                ...
                <div class="modal-dialog" role="document" id="step-8">
                    <div class="modal-content border-0 modl" id="step-6">
                        <div class="modal-header border-0">
                            <h5 class="modal-title m-auto pt-3" style="font-weight: 600;">Create An Account</h5>
                        </div>
                        <div class="modal-body">
                             ...
                             <div id="step-2">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group col-sm-9 m-auto pt-4">
                                        <label for="exampleInputEmail1" style="font-weight: 600;">E-mail address</label>
                                    ...
                                    <div class="form-group col-sm-9 m-auto pt-4">
                                        ...
                                        <input type="password"  class="form-control c_password_validation" placeholder="Re-enter your Password">
                                    ...
                                    <div class="form-group col-sm-9 m-auto pt-4">
                                        ...
                                        <div class="autocomplete" style="width:320px;">
                                            <input type="text" id="myInput" class="form-control company_validation"  aria-describedby="emailHelp" placeholder="Your company name" name="company_name">
                            ...
                            <div class="help-block with-errors"></div>
                                    ...
                                    <p class="text-secondary text-center mt-4" style="font-size: 14px;">Already have an account?<a href="{{url('/login')}}" class="text-info ml-3" style="font-weight: 600">Login here</a></p>
</form>
                            </div>

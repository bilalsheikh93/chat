        ...
        <div class="col-md-10 pl-0  m-auto ml-0 pr-0 mr-0 pb-5" style="background:white;">
            ...
            <div class="row">
                ...
                <div class="col-md-9 pt-3 pr-5">
                    ...
                    <div class="mt-3">
                        <label for="" class="font-weight-bold" style="font-size:13px;">Change Company</label>
                        <input type="text" class="form-control w-75" name="company_name" placeholder="company ABC, inc." value="{{ $user->company_name }}">
                    </div>
                    <div class="mt-3">
                            <label  class="font-weight-bold" style="font-size:13px;" for="input">Change Icon!</label>
                        <div class="container">
                            <div class="input">
                ...
                @if($user->role == 'admin')
                    <div class="mt-3">
                        <label for="" class="font-weight-bold" style="font-size:13px;">Change Credit Card Information</label><br>
                        {{-- <input type="text" class="form-control w-75" placeholder="Credit Card Infor.." > --}}
                        <a href="{{ url('/change_credit_card_info') }}" class="btn btn-primary">Change Credit Card Information</a>
                    </div>
                    <div class="mt-3">
                        <label for="" class="font-weight-bold" style="font-size:13px;">Buy another Subscription</label><br>
                        {{-- <input type="text" class="form-control w-75" readonly placeholder="Subscription level: Unlimited" value="{{ $user->plan_name }}"> --}}
                        <a href="{{ url('/change_plan') }}" class="btn btn-primary">Subscription level: <?php echo ucfirst($user->plan_name); ?><span class="ml-2">{{ $final }}</span>  </a>
                    </div>
                @endif
                    <div class="row mt-3">
                        <div class="col-md-6">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="background:#f8fafb;">
                    ...
                    <form method="post" action="{{ url('send_pass_var') }}" >
                ...
                <div class="col-md-6 text-right">
                    <a href="{{ url('/profile') }}" class="btn w-50" style="background:#f2f4f6;color:#798da3; font-size:14px; font-weight:500;" data-dismiss="modal">CANCEL</a>
                </div>
                </div>

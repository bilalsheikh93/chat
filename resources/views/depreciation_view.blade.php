        ...
        <div class="col-md-9 p-4 rounded m-auto"style="background:white;">
            <form action="">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-8">
                        <button type="button" class="btn" id="add_depreciation" style="background: #8663c0;color: white;">Add Depreciation  Expenses</button>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-4 mt-2">
                        <label for="" class="time_period text-left">Property Value:</label>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row mt-3">
                    <div class="col-md-4 mt-2">
                        <label for="" class="time_period text-left">Depreciation Rate:</label>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row mt-3">
                    <div class="col-md-4 mt-2">
                        <label for="" class="time_period text-left">Depreciation Expense:</label>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row mt-3">
                    <div class="col-md-4 mt-2">
                        <label for="" class="time_period text-left">Accumulated Depreciation:</label>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row mt-3">
                    <div class="col-md-4 mt-2">
                        <label for="" class="time_period text-left">Property Type:</label>
                    </div>
                    <div class="col-md-4">
                        <select name="" class="custom-select" id="">
                            <option value="">Business Courses</option>
                ...
                <div class="text-right mt-4">
                    <a href="{{ URL('/sales') }}" class="bnt-33" style="text-decoration: none;color: white;">Submit</a>                
                </div>
            </form> 
        </div>
    </div>

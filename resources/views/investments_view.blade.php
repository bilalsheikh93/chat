        ...
        <div class="col-md-9 p-4 rounded m-auto"style="background:white;">
            <form action="">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control bg-primary" name="" id="date">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-4 mt-2">
                        <label for="" class="time_period text-left">Investments Made:</label>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row mt-3">
                    <div class="col-md-4 mt-2">
                        <label for="" class="time_period text-left">Dividends Paid/Owner Distributions:</label>
                    </div>
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="" placeholder="1,000,000">
                    </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-8">
                        <a href="#" id="add_depreciation_1">Add Amortization Expenses</a>
                    </div>
                </div>
                <div class="row mt-3" id="description_1">
                ...
                <div class="text-right mt-4">
                    <a href="{{ URL('/transaction_execution_costs') }}" class="bnt-33" style="text-decoration: none;color: white;">Submit</a>
                </div>
            </form> 
        </div>
    </div>

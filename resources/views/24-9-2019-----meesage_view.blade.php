                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="member_list">
                                            <ul class="list-unstyled" id="member_list">
                                              ...
                                              @elseif($message->s_id == Auth::user()->id)
                                              ...
                                              <li class="left clearfix user_chat_link" data-user-id="{{ $chat_user_id }}" data-conv-id="{{ $message->cnv_id }}" data-user-name="{{ $chat_user_name }}">
                                                  <span class="chat-img float-left">
                                                      @if ($chat_user_image)
                                                  <img src="{{ url('/').'/public/user_images/'.$chat_user_image }}" class="img-circle">
                                                  @else
                                                  <img src="{{ url('/').'/public/public_site_assets/img/User.png' }}" class="img-circle">
                                                  @endif
                                                  </span>
...
<script>
  ...
  $(document).ready(function (){
        ...
        //     var conv_id = "";
        //     var name = $('#chat_user_name').html($(this).attr('data-user-name'));

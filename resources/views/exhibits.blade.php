...
<!--Exhibits form-->
  ...
  <div id="form-step-8">
    ...
    <form action="{{ url('/add_step_7') }}" method="POST">
          ...
          <div class="row">
            <div class="col-md-12 pl-0 pr-0">
              <div class="border-bottom ml-3 mr-3">
                <h5 class="p-2 ml-3 mt-3 font-weight-bold" style="font-size: inherit;">Exhibits</h5>
              </div>
              <div class="form-row ml-4 mt-4 mr-4 text-center">
                <div class="col-md-3 pr-0 text-left" style="max-width:20% !important;">
                    <label class="mt-3 ml-2 mr-0" style="font-size: 13px;">Name:</label>
                </div>
                <div class="col-md-8 pl-0 text-left">
                  <input type="text" name="exhibit_name" class="form-control" required>
                </div>
              </div>
              <div class="form-row ml-4 mt-4 mr-4 text-center">
                <div class="col-md-3 pr-0 text-left" style="max-width:20% !important;">
                    <label class="mt-3 ml-2 mr-0" style="font-size: 13px;">Description:</label>
                </div>
                <div class="col-md-8 pl-0 text-left">
                  <textarea type="text" name="exhibit_description" class="form-control" rows="3" required></textarea>
                </div>
              </div>
              <div class="ml-2 mt-5">
                <h6 class="ml-4 assin" style="width:8% !important;">Related to:</h6>
              </div>
              
              <div class="row ml-3 mr-3">
                  <?php for($j=0; $j < count($get_model_values); $j++){ ?>
              ...
              <div class="mt-5 pt-5 fmrs">
                <div class="form-row ml-3 mr-3 border-top">
                  ...
                  <div class="col-md-6 mt-4 pr-5 text-right">
                      <button type="submit" class="bnt-21 w-25" id="btn-1-7">Next</button>
                  </div>
                </div>
              </div>
            </div>
...
<script>
    $(function(){
        $("#btn-1-7").click(function(){
            ...
            {
                alert("Sorry! Please Select one Exhibit Value");
                return false;
            }
        });
    });
